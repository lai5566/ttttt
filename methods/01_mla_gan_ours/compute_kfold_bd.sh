...
# K=5 全部一致（ir5/ir10/ir20）。
# ir10 已有 data/classifiers/kfold_bd.json（k=5），預設不重算（傳 ir10 參數可重算）。
set -euo pipefail
cd "$(dirname "$0")/code"
...
case "$IR" in
  ...
  ir20) run ir20 5  ct_256_ir20 ;;
  ir10) run ir10 5  ct_256 ;;
  all)  run ir5 5 ct_256_ir5; run ir20 5 ct_256_ir20 ;;
